function user_job_setup()
	...
	state.Weapons:options('Naegsak','Learn')
...
function init_gear_sets()
	...
	sets.HPCure = {--main="Bunzi's Rod",sub="Nibiru Cudgel",
	...
	sets.precast.FC = {--main="Vampirism",sub="Sakpata's Sword",
		ammo="Impatiens",
	...
	-- Midcast Sets
	sets.midcast.FastRecast = {--main="Vampirism",sub="Sakpata's Sword",
		ammo="Hasty Pinion +1",
	...
	sets.midcast['Blue Magic'].Physical = {--main="Vampirism",sub="Vampirism",
		ammo="Mavi Tathlum",
	...
	sets.midcast['Blue Magic'].Physical.Resistant = {--main="Sequence",sub="Almace",
		ammo="Falcon Eye",
	...
	sets.midcast['Blue Magic'].Physical.Fodder = {--main="Iris",sub="Iris",
		ammo="Mavi Tathlum",
	...
	sets.midcast['Blue Magic'].PhysicalAcc = {--main="Sequence",sub="Almace",
		ammo="Falcon Eye",
		head="Jhakri Coronal +2",neck="Mirage Stole +2",ear1="Regal Earring",ear2="Telos Earring",
	...
	sets.midcast['Blue Magic'].Magical = {--main="Bunzi's Rod",sub="Maxentius",
		ammo="Ghastly Tathlum +1",
		 head="Jhakri Coronal +2",neck="Baetyl Pendant",ear1="Regal Earring",ear2="Friomisi Earring",
	...
	sets.midcast['Blue Magic'].Magical.SIRD = {--main="Bunzi's Rod",sub="Sakpata's Sword",
		ammo="Staunch Tathlum +1",
	...
	sets.midcast['Blue Magic'].Subduction = {--main="Bunzi's Rod",sub="Maxentius",
		ammo="Ghastly Tathlum +1",
		 head="Jhakri Coronal +2",neck="Baetyl Pendant",ear1="Regal Earring",ear2="Friomisi Earring",
		 body="Amalric Doublet +1",hands="Amalric Gages +1",ring1="Metamor. Ring +1",ring2="Shiva Ring +1",
		 back=gear.nuke_jse_back,waist=gear.ElementalObi,legs="Luhlaza Shalwar +3",feet="Amalric Nails +1"}
	...
	sets.midcast['Blue Magic'].Magical.Fodder = {--main="Bunzi's Rod",sub="Maxentius",
		ammo="Pemphredo Tathlum",
		head="Jhakri Coronal +2",neck="Baetyl Pendant",ear1="Regal Earring",ear2="Friomisi Earring",
		body="Amalric Doublet +1",hands="Amalric Gages +1",ring1="Metamor. Ring +1",ring2="Shiva Ring +1",
	...
	sets.midcast['Blue Magic'].MagicAccuracy = {--main="Tizona",sub="Sakpata's Sword",
		ammo="Pemphredo Tathlum",
	...
	sets.midcast['Enfeebling Magic'] = {--main="Tizona",sub="Sakpata's Sword",
		ammo="Pemphredo Tathlum",
	...
	sets.midcast['Dark Magic'] = {--main="Tizona",sub="Sakpata's Sword",
		ammo="Pemphredo Tathlum",
	...
	sets.midcast['Enhancing Magic'] = {--main="Vampirism", sub="Sakpata's Sword",
		ammo="Hasty Pinion +1",
	...
	sets.midcast['Elemental Magic'] = {--main="Maxentius",sub="Sakpata's Sword",
		ammo="Ghastly Tathlum +1",
		head="Jhakri Coronal +2",neck="Baetyl Pendant",ear1="Regal Earring",ear2="Friomisi Earring",
		body="Amalric Doublet +1",hands="Amalric Gages +1",ring1="Shiva Ring +1",ring2="Shiva Ring +1",
		back=gear.nuke_jse_back,waist=gear.ElementalObi,legs="Luhlaza Shalwar +3",feet="Amalric Nails +1"}

	sets.midcast['Elemental Magic'].Resistant = {--main="Maxentius",sub="Sakpata's Sword",
		ammo="Pemphredo Tathlum",
	...
	sets.midcast.Cure = {--main="Bunzi's Rod",sub="Sakpata's Sword",
		ammo="Staunch Tathlum +1",
	...
	sets.midcast.UnlockedCure = {--main="Bunzi's Rod",sub="Sakpata's Sword",
		ammo="Staunch Tathlum +1",
		head="Nyame Helm",neck="Loricate Torque +1",ear1="Regal Earring",ear2="Mendi. Earring",
	...
	sets.midcast['Blue Magic'].Stun = {--main="Tizona",sub="Sakpata's Sword",
		ammo="Pemphredo Tathlum",
		head="Malignance Chapeau",neck="Mirage Stole +2",ear1="Regal Earring",ear2="Digni. Earring",
	...
	sets.midcast['Blue Magic'].Stun.Resistant = {--main="Tizona",sub="Sakpata's Sword",
		ammo="Falcon Eye",
		head="Malignance Chapeau",neck="Mirage Stole +2",ear1="Regal Earring",ear2="Digni. Earring",
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
		back="Cornflower Cape",waist="Olseni Belt",legs="Malignance Tights",feet="Malignance Boots"}
	...
	sets.midcast['Blue Magic'].UnlockedAoEHealing = {--main="Bunzi's Rod",sub="Sakpata's Sword",
		ammo="Staunch Tathlum +1",
	...
	sets.midcast['Blue Magic'].AoEHealing = {--main="Bunzi's Rod",sub="Sakpata's Sword",
		ammo="Staunch Tathlum +1",
		head="Nyame Helm",neck="Unmoving Collar +1",ear1="Tuisto Earring",ear2="Odnowa Earring +1",
		body="Vrikodara Jupon",hands="Telchine Gloves",ring1="Janniston Ring",ring2="Gelatinous Ring +1",
		back="Moonlight Cape",waist="Eschan Stone",legs="Nyame Flanchard",feet="Nyame Sollerets"}

	sets.midcast['Blue Magic'].Healing = {--main="Bunzi's Rod",sub="Sakpata's Sword",
		ammo="Staunch Tathlum +1",
	...
	sets.midcast['Blue Magic'].UnlockedHealing = {--main="Bunzi's Rod",sub="Sakpata's Sword",
		ammo="Staunch Tathlum +1",
		head="Nyame Helm",neck="Loricate Torque +1",ear1="Regal Earring",ear2="Mendi. Earring",
		body="Nyame Mail",hands="Telchine Gloves",ring1="Metamor. Ring +1",ring2="Janniston Ring",
		back="Moonlight Cape",waist="Luminary Sash",legs="Nyame Flanchard",feet="Nyame Sollerets"}

	sets.midcast['Blue Magic'].SkillBasedBuff = {--main="Iris",sub="Iris",
		ammo="Mavi Tathlum",
	...
	sets.midcast['Blue Magic'].Buff = {--main="Vampirism",sub="Vampirism",
		ammo="Mavi Tathlum",
	...
	sets.Learning = {hands="Assim. Bazu. +1"}  --"Assim. Bazu. +3"

	-- Resting sets
	sets.resting = {--main="Bolelabunga",sub="Genmei Shield",
				ammo="Falcon Eye",
	...
	sets.idle.PDT = {--main="Sakpata's Sword",sub="Genmei Shield",
				ammo="Staunch Tathlum +1",
	...
	-- Weapons sets
	sets.weapons.Naegsak = {main="Naegling",sub="Sakpata's Sword"}
	sets.weapons.Learn = {main="Caduceus",sub="Genbu's Shield"}
	...
	sets.engaged = {--main="Tizona",sub="Almace",
				ammo="Aurgelmir Orb +1",
	...
	sets.engaged.AM = {--main="Tizona",sub="Almace",
				ammo="Aurgelmir Orb +1",
	...
	sets.engaged.Acc = {--main="Tizona",sub="Almace",
				ammo="Falcon Eye",
				head="Dampening Tam",neck="Mirage Stole +2",ear1="Cessance Earring",ear2="Telos Earring",
	...
	sets.engaged.Acc.AM = {--main="Tizona",sub="Almace",
				ammo="Falcon Eye",
	...
	sets.engaged.Acc.DT.AM = {--main="Tizona",sub="Almace",
				ammo="Falcon Eye",
			    head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Digni. Earring",ear2="Telos Earring",
			    body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Ilabrat Ring",
			    back=gear.stp_jse_back,waist="Reiki Yotai",legs="Malignance Tights",feet="Malignance Boots"}

	sets.engaged.FullAcc.DT = {--main="Tizona",sub="Almace",
				ammo="Falcon Eye",
	...
	sets.engaged.Fodder.DT = {--main="Tizona",sub="Almace",
				ammo="Aurgelmir Orb +1",
			    head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Cessance Earring",ear2="Brutal Earring",
			    body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Petrov Ring",
			    back=gear.da_jse_back,waist="Reiki Yotai",legs="Malignance Tights",feet="Malignance Boots"}

	sets.engaged.Fodder.DT.AM = {--main="Tizona",sub="Almace",
				ammo="Aurgelmir Orb +1",
			    head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Cessance Earring",ear2="Telos Earring",
			    body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Petrov Ring",
			    back=gear.stp_jse_back,waist="Reiki Yotai",legs="Malignance Tights",feet="Malignance Boots"}
